...
$activo = 0;
$tipo_usuario = 2;
$secret = '6LdCbvcUAAAAABTZz15348nqo8XYwGnQUhLd3fgv';
	...
	if(usuarioExiste($usuario))
	{
		...
		$errors[] = "El nombre de usuario $usuario ya estiste";
	}

	if(emailExiste($usuario))
	{

		$errors[] = "El correo electronico $email ya estiste";
	}
	...
	if (count($errors) == 0 ) 
	{
		...
		if ($registro > 0) 
		{
			...
			$asunto = 'Activar Cuenta - E.H Software';
			$cuerpo = "Estimado $nombre: <br /><br />Para continuar con el proceso de registro, debe dar click en la siguiente liga <a href='$url'>Activar Cuenta</a>";
					...
					<div class="panel-body" >
						...
						<form id="signupform" class="form-horizontal" role="form" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" autocomplete="off">
							...
							<div class="form-group">
								...
								<div class="g-recaptcha col-md-9" data-sitekey="6LdCbvcUAAAAAEgF-PSD_JOrFu3nhOynBqbxOAMr"></div>
							</div>
